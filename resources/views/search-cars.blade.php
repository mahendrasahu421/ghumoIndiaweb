...
<!-- Mirrored from demo.gridgum.com/templates/Travel-agency/search-cars.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Aug 2023 06:35:53 GMT -->
<head>
                            ...
                            <div class="star_rating">
                                <form>
                                    <div>
                                        ...
                                        <label for="checkbox-1" class="checkbox1-custom-label"><span>Premium</span></label>
                                    </div>
                                    <div>
                                        <input id="checkbox-2" class="checkbox1-custom" name="checkbox-2" type="checkbox">
                                        <label for="checkbox-2" class="checkbox1-custom-label"><span>Automatic Cars</span></label>
                                    </div>
                                    <div>
                                        <input id="checkbox-3" class="checkbox1-custom" name="checkbox-3" type="checkbox" checked>
                                        <label for="checkbox-3" class="checkbox1-custom-label"><span>Small & Medium Cars</span></label>
                                    </div>
                                    <div>
                                        <input id="checkbox-4" class="checkbox1-custom" name="checkbox-4" type="checkbox">
                                        <label for="checkbox-4" class="checkbox1-custom-label"><span>Sedans</span></label>
                                    </div>
                                    <div>
                                        <input id="checkbox-5" class="checkbox1-custom" name="checkbox-5" type="checkbox">
                                        <label for="checkbox-5" class="checkbox1-custom-label"><span>MPV & Family Cars</span></label>
                                    </div>
                                ...
                                <div class="thumbnail clearfix">
                                    <figure>
                                        ...
                                        <div class="over">
                                            ...
                                            <div class="v2">5 Door / Manual transmission / 5 passenger</div>
                                        </div>
                                    </figure>
                                    <div class="caption">
                                        ...
                                        <div class="txt3 clearfix">
                                            ...
                                            <div class="right_side"><a href="https://demo.gridgum.com/templates/Travel-agency/booking-cars.html" class="btn-default btn1">Details</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="thumbnail clearfix">
                                    <figure>
                                        ...
                                        <div class="over">
                                            ...
                                            <div class="v2">3 Door / Manual transmission / 4 passenger</div>
                                        </div>
                                    </figure>
                                    <div class="caption">
                                ...
                                <div class="thumbnail clearfix">
                                    <figure>
                                        ...
                                        <div class="over">
                                            ...
                                            <div class="v2">5 Door / Manual transmission / 4 passenger</div>
                                        </div>
                                    </figure>
                                    <div class="caption">
                                ...
                                <div class="thumbnail clearfix">
                                    <figure>
                                        ...
                                        <div class="over">
                                            ...
                                            <div class="v2">4 Door / Automatic / 5 passenger</div>
                                        </div>
                                    </figure>
                                    <div class="caption">
                                ...
                                <div class="thumbnail clearfix">
                                    <figure>
                                        ...
                                        <div class="over">
                                            ...
                                            <div class="v2">4 Door / Manual transmission / 5 passenger</div>
                                        </div>
                                    </figure>
                                    <div class="caption">
                                ...
                                <div class="thumbnail clearfix">
                                    <figure>
                                        ...
                                        <div class="over">
                                            ...
                                            <div class="v2">4 Door / Automatic / 10 passenger</div>
                                        </div>
                                    </figure>
                                    <div class="caption">
                                ...
                                <div class="thumbnail clearfix">
                                    <figure>
                                        ...
                                        <div class="over">
                                            ...
                                            <div class="v2">4 Door / Automatic / 12 passenger</div>
                                        </div>
                                    </figure>
                                    <div class="caption">

...
<!-- Mirrored from demo.gridgum.com/templates/Travel-agency/booking-cars-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Aug 2023 06:35:53 GMT -->
<head>
...
<div id="main">
    ...
    <div id="content">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="text-center hch2">MERCEDES BENZ ML (or similar)</h3>
                    ...
                    <div class="col-md-4 booking-row">
                        <h3 class="line">CARS SUMMARY</h3>
                        <div class="input2_wrapper">
                            <label class="col-md-6" style="padding-left:0;padding-top:12px;">Pick up:</label>
                        ...
                        <div class="clearfix"></div>
                        <div class="input2_wrapper">
                            <label class="col-md-6" style="padding-left:0;padding-top:12px;">Return:</label>
                            <div class="col-md-6" style="padding-right:0;padding-left:0;">
                                <span class="red">Prague</span>

...
<!-- Mirrored from demo.gridgum.com/templates/Travel-agency/booking-cars.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Aug 2023 06:35:53 GMT -->
<head>
    ...
    <script src="https://demo.gridgum.com/templates/Travel-agency/js/googlemap5.js"></script>
                ...
                <div class="col-sm-3">
                    <div class="sidebar-block">
                        <form action="https://demo.gridgum.com/templates/Travel-agency/javascript;">
                            ...
                            <span class="similar">or similar</span>
                            ...
                            <div class="col-sm-12 no-padding margin-top">
                                <div class="input1_wrapper">
                                    ...
                                    <div class="col-md-6 price-left" style="padding-right:0;padding-left:0;">
                                        <span class="red">$72.9</span>/<span class="blue">day</span>
                                    </div>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            ...
                            <div class="no-padding margin-top text-center" style="margin-top:30px;">
                                <a href="https://demo.gridgum.com/templates/Travel-agency/booking-cars-page.html" class="btn btn-default btn-cf-submit3" style="width:100%;">BOOKING NOW</a>
                            </div>
                            <div class="clearfix"></div>
                ...
                <div class="col-sm-9">
                    <div class="blog_content">
                        ...
                        <div class="post post-full">
                            <h3 class="hch">MERCEDES BENZ ML</h3>
                                                ...
                                                <div class="carousel main">
                                                    <ul>
                                                        <li>
                                                            <div class="sl1">
                                                                <div class="sl1_inner">
                                                                    <img src="https://demo.gridgum.com/templates/Travel-agency/images/auto01.jpg" alt="" class="img-responsive">
                                                                </div>
                                                            </div>
                                                        </li>
                                ...
                                <div class="post-story-body clearfix">
                                    ...
                                    <h4>Price excludes:</h4>
                                      <ul>
                                          ...
                                          <li>Personal accident protection (driver & passengers) USD 49.78 per rental Fuel.</li>
                                          <li>Return the vehicle with the same level of fuel or use our refuelling service (price communicated at pick-up).</li>
